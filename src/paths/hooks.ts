...
export const registerHookRoutes = (
  ...
  router.post("/hooks/push", async (req, res) => {
    ...
    const repoMeta = await deps.repoMetadata.getByForgejoName(
    ...
    deps.nats.publish(subject, sc.encode(JSON.stringify(pushEvent)))
